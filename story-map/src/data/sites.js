export const sites = {
  ...
  */
  'nueima-solar-fields': {
    ...
    name: 'Noor Jericho Solar Power Station',
  ...
  'netiv-hagdud': {
    id: 'netiv-hagdud',
    name: 'Netiv HaGdud',
    pointGeoJson: '/data/geojson/Netiv HaGdud.geojson',
    tableCsv: '/data/tables/OTS_Solar Fields - Netiv Hagdud.csv',
  },
  'petzael': {
    id: 'petzael',
    name: 'Petzael',
  ...
  */
  'shdemot-mehola-solar': {
    ...
    name: 'Shadmot Mehola Solar Field',
  ...
  'jericho-governate': {
    ...
    name: 'Jericho Governorate Building',
